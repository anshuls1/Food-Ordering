$(document).ready(function() {
    //checking if local storage value of "cart retrived " is True
    retrieve_saved_cart()

    if (window.location.href.indexOf("cart") > -1) {
      //this will dynamically generate the cart on the page
      load_cart()
    }
...
function order_list_functionality(){
  onRowClick("orders_table", function (row){
    ...
    //we send get request to see if user has superuser person
